...
const CategoryDrawer = ({ opened, onClick }) => {
    return (
        <div className="relative bg-white border-gray-200 rounded dark:bg-gray-900 container flex flex-wrap items-center justify-between mx-auto" onClick={onClick}>
            ...
            {
                opened ?
                <div className="absolute -mt-80 w-44 md:block md:w-auto" id="navbar-default">
                    <ul className="relative flex flex-col w-full p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
